...
.prokuratura-page, .prokuratura-page * { box-sizing: border-box; }
.prokuratura-page {
  --bg: #f5f1ea;
  --paper: #fffdf8;
  --text: #1f2328;
...
.prokuratura-kicker, .prokuratura-date, .prokuratura-source, .prokuratura-subtitle { color: var(--muted); font-family: Arial, sans-serif; }
.prokuratura-kicker { margin: 0 0 10px !important; color: var(--accent); font-size: 10px !important; font-weight: 700; letter-spacing: 0.07em; text-transform: uppercase; }
.prokuratura-article h1 { margin: 0 0 12px !important; font-size: clamp(26px, 3.7vw, 34px) !important; line-height: 1.08 !important; letter-spacing: -0.04em; font-weight: 800; }
.prokuratura-subtitle { margin: 0 0 16px !important; color: #30373b; font-size: 21px !important; font-style: italic; line-height: 1.45 !important; }
.prokuratura-article h2 { margin: 38px 0 14px; font-size: clamp(24px, 3vw, 32px); line-height: 1.18; letter-spacing: -0.025em; }
.prokuratura-article p, .prokuratura-article li { font-size: 19px; }
.prokuratura-article p { margin: 0 0 18px; }
.prokuratura-lead { color: #30373b; border-left: 5px solid var(--accent); padding-left: 18px; margin-bottom: 26px; font-size: 23px !important; line-height: 1.5; }
.prokuratura-date, .prokuratura-source { font-size: 0.95em; }
.prokuratura-source { font-size: 14px !important; line-height: 1.45 !important; }
.prokuratura-note {
  background: #f4f2ed;
...
.prokuratura-date { margin: -4px 0 22px; }
.prokuratura-hero { margin: 30px 0 14px; }
.prokuratura-hero img { display: block; width: 100%; height: auto; border: 1px solid var(--line); border-radius: 6px; box-shadow: 0 12px 28px rgba(0, 0, 0, 0.16); }
.prokuratura-caption { color: var(--muted); font-size: 14px !important; font-style: italic; line-height: 1.45 !important; }
.prokuratura-article blockquote { border-left: 5px solid var(--accent); color: #30373b; margin: 24px 0; padding: 2px 0 2px 18px; }
...
@media (max-width: 720px) {
  ...
  .prokuratura-article p, .prokuratura-article li { font-size: 18px; }
  .prokuratura-lead { font-size: 20px !important; }
  .prokuratura-subtitle { font-size: 19px !important; }
}
</style>
...
Apie prokuratūros veiksmus esu rašęs straipsnyje [UAB „Prokuratūra“: kai bendruomenės gynimas prilyginamas nusikaltimui](/daugiabucio-igaliotinio-uzrasai/prokuratura/uab-prokuratura-bendruomenes-gynimas/), todėl dabar nesikartosiu.
...
<figure class="prokuratura-hero">
  <img
    src="/daugiabucio-igaliotinio-uzrasai/savivaldybe/romualdas-pliavga-vilniaus-savivaldybe-reikalavimai.webp"
    alt="Romualdas Pliavga, Vilniaus miesto savivaldybės pareigūnas, pasirašęs Evaldo Jablonsko atžvilgiu siųstus reikalavimus"
    title="Romualdas Pliavga – Vilniaus miesto savivaldybės reikalavimai"
  >
</figure>
...
<div class="prokuratura-share">
  ...
  <div class="prokuratura-share-actions">
    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fevaldasjablonskas.lt%2Fdaugiabucio-igaliotinio-uzrasai%2Fsavivaldybe%2Flaurynas-kasciunas-valstybes-priesas%2F" target="_blank" rel="noopener">Dalintis „Facebook“</a>
    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fevaldasjablonskas.lt%2Fdaugiabucio-igaliotinio-uzrasai%2Fsavivaldybe%2Flaurynas-kasciunas-valstybes-priesas%2F" target="_blank" rel="noopener">Dalintis „LinkedIn“</a>
    <button type="button" onclick="navigator.clipboard.writeText('https://evaldasjablonskas.lt/daugiabucio-igaliotinio-uzrasai/savivaldybe/laurynas-kasciunas-valstybes-priesas/').then(() => { this.textContent = 'Nuoroda nukopijuota'; });">Kopijuoti nuorodą</button>
  </div>
</div>
