...
breadcrumbs:
  ...
  - name: "VVTAT – vartotojų gynėja ar dar viena biurokratinė siena?"
    url: "/daugiabucio-igaliotinio-uzrasai/vvtat/vvtat-vartotoju-gyneja-ar-dar-viena-biurokratine-siena/"
---

<style>
html { overflow-x: hidden !important; }
body { background: #f5f1ea !important; margin: 0 !important; overflow-x: hidden !important; }
.vvtat-page, .vvtat-page * { box-sizing: border-box; }
.vvtat-page { --bg: #f5f1ea; --paper: #fffdf8; --text: #1f2328; --muted: #68615a; --line: #ded4c7; --accent: #5d2d82; --soft: #eee4f4; background: var(--bg); color: var(--text); font-family: Georgia, "Times New Roman", serif; line-height: 1.72; width: 100vw; max-width: none !important; min-height: 100vh; margin: 0 0 0 50%; padding: 8px 18px 60px; transform: translateX(-50%); }
.vvtat-article { width: 100%; max-width: 944px; margin: 0 auto; background: var(--paper); border: 1px solid var(--line); box-shadow: 0 18px 45px rgba(0,0,0,.08); padding: 22px 54px 54px; }
.vvtat-kicker, .vvtat-date, .vvtat-source, .vvtat-series { color: var(--muted); font-family: Arial, sans-serif; }
.vvtat-kicker { margin: 0 0 10px !important; color: var(--accent); font-size: 10px !important; font-weight: 700; letter-spacing: .07em; text-transform: uppercase; }
.vvtat-article h1 { margin: 0 0 16px !important; font-size: clamp(28px, 3.7vw, 40px) !important; line-height: 1.08 !important; letter-spacing: -.04em; font-weight: 800; }
.vvtat-article h2 { margin: 38px 0 14px; font-size: clamp(24px, 3vw, 32px); line-height: 1.18; letter-spacing: -.025em; }
.vvtat-article p, .vvtat-article li { font-size: 19px; }
.vvtat-article p { margin: 0 0 18px; }
.vvtat-lead { color: #3b352f; border-left: 5px solid var(--accent); padding-left: 18px; margin-bottom: 26px; font-size: 23px !important; line-height: 1.5; }
.vvtat-date, .vvtat-source, .vvtat-series { font-size: .95em; }
...
.vvtat-status { background: var(--soft); border-left: 5px solid var(--accent); padding: 18px 20px; margin: 24px 0; }
.vvtat-share { margin: 28px 0 18px; padding: 18px 20px; border-top: 1px solid var(--line); border-bottom: 1px solid var(--line); font-family: Arial, sans-serif; }
.vvtat-share strong { display: block; margin-bottom: 12px; font-size: 17px; }
.vvtat-share-actions { display: flex; flex-wrap: wrap; gap: 10px; }
.vvtat-share-actions a, .vvtat-share-actions button { appearance: none; border: 1px solid var(--accent); border-radius: 4px; background: var(--paper); color: var(--accent); cursor: pointer; display: inline-flex; align-items: center; min-height: 38px; padding: 8px 12px; font: 700 14px/1.2 Arial, sans-serif; text-decoration: none; }
.vvtat-share-actions a:hover, .vvtat-share-actions button:hover { background: var(--soft); }
@media (max-width: 720px) { .vvtat-page { padding: 0; } .vvtat-article { border-left: 0; border-right: 0; padding: 28px 20px 42px; } .vvtat-article p, .vvtat-article li { font-size: 18px; } .vvtat-lead { font-size: 20px !important; } }
</style>

<main class="vvtat-page" markdown="1">
<article class="vvtat-article" markdown="1">

<p class="vvtat-kicker">Daugiabučio įgaliotinio užrašai / VVTAT</p>
...
<p class="vvtat-caption">Dirbtiniu intelektu sukurta simbolinė redakcinė iliustracija straipsniui „VVTAT – vartotojų gynėja ar dar viena biurokratinė siena?“. Kairėje pavaizduota VVTAT direktorės pavaduotoja Aida Gasiūnaitė-Stavginskienė, dešinėje – VVTAT direktorė <strong>Goda Aleksaitė</strong>. Iliustracija skirta Evaldo Jablonsko viešam klausimui apie daugiabučio įgaliotinio, administratoriaus ir VVTAT atsakomybės ribas; ji nėra dokumentinė konkretaus įvykio nuotrauka.</p>

<p class="vvtat-source">Autorius: Evaldas Jablonskas. Publikacijoje pateikiama asmeninė patirtis ir vertinimas, grindžiamas mano susirašinėjimu su institucijomis, jų atsakymais ir dokumentais.</p>

<p class="vvtat-lead">Įsivaizduokite: esate paprastas daugiabučio gyventojas. Kaimynai paprašo jūsų atstovauti bendriems namo interesams – pasirašyti sutartis, bendrauti su administratoriumi ir spręsti bendras problemas.</p>
...
<div class="vvtat-status">
  <strong>Vilniaus miesto apylinkės teismo konstatuota aplinkybė:</strong><br>
...
[Kai savivaldybė daugiabučio įgaliotinį prilygina administratoriui](/daugiabucio-igaliotinio-uzrasai/savivaldybe/) – ankstesnis tekstas apie įgaliotinio ir administratoriaus statuso painiojimą.

[Ar verta pirkti butą iš „Citus“? Viešas klausimas Mindaugui Vanagui dėl užliejamo požeminio parkingo](/daugiabucio-igaliotinio-uzrasai/citus/mindaugas-vanagas-uzliejamas-parkingas/) – tekstas apie statytojo defektus, gyventojų atstovavimą ir ilgai sprendžiamą požeminio parkingo problemą.
<div class="vvtat-share">
  <strong>Pasidalinti straipsniu</strong>
  <div class="vvtat-share-actions">
    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fevaldasjablonskas.lt%2Fdaugiabucio-igaliotinio-uzrasai%2Fvvtat%2Fvvtat-vartotoju-gyneja-ar-dar-viena-biurokratine-siena%2F" target="_blank" rel="noopener">Dalintis „Facebook“</a>
    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fevaldasjablonskas.lt%2Fdaugiabucio-igaliotinio-uzrasai%2Fvvtat%2Fvvtat-vartotoju-gyneja-ar-dar-viena-biurokratine-siena%2F" target="_blank" rel="noopener">Dalintis „LinkedIn“</a>
    <button type="button" onclick="navigator.clipboard.writeText('https://evaldasjablonskas.lt/daugiabucio-igaliotinio-uzrasai/vvtat/vvtat-vartotoju-gyneja-ar-dar-viena-biurokratine-siena/').then(() => { this.textContent = 'Nuoroda nukopijuota'; });">Kopijuoti nuorodą</button>
  </div>
</div>
...
<p class="vvtat-series"><a href="/daugiabucio-igaliotinio-uzrasai/">Grįžti į ciklo puslapį</a></p>
